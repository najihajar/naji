        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg custom-container">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('admin/annonces/store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\HP\Desktop\monStg\myproj\resources\views/admin/annonce/create.blade.php ENDPATH**/ ?>