...
<div class="content-section">
    ...
    <div class="image-content">
        <img src="<?php echo e(asset('images/img.jpg')); ?>" alt="Photo de la résidence" class="img-fluid">
    </div>
</div>
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
            ...
            <div class="col">
                <div class="card gallery-card">
                    <img src="<?php echo e(asset('images/img.jpg')); ?>" class="card-img-top" alt="Photo 1">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card gallery-card">
                    <img src="<?php echo e(asset('images/img.jpg')); ?>" class="card-img-top" alt="Photo 2">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card gallery-card">
                    <img src="<?php echo e(asset('images/img.jpg')); ?>" class="card-img-top" alt="Photo 3">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card gallery-card">
                    <img src="<?php echo e(asset('images/img.jpg')); ?>" class="card-img-top" alt="Photo 4">
                    <div class="card-body">
...
<?php echo $__env->make('base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/yennajy/Desktop/multi auth/multi_auth_laravel/resources/views/accueil/presentation.blade.php ENDPATH**/ ?>